    ...
    <section className="w-full py-20" id="approach">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description="Lorem ipsum dolor, sit amet consectetur adipisicing elit. Provident, expedita asperiores quia esse quo accusantium."
        >
          <CanvasRevealEffect animationSpeed={5.1} containerClassName="bg-emerald-900" />
        </Card>
        <Card
          title="Agile SDLC Project Progression"
...
const Card = ({ title, icon, children, description }: { title: string; icon: React.ReactNode; children?: React.ReactNode; description: string }) => {
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative h-[30rem] lg:h-[35rem]"
    >
